...
import type { TemperatureDistribution } from '@/types/analytics'
...
export function TemperatureGauge({ data }: { data: TemperatureDistribution }) {
      ...
      <CardContent className="space-y-3">
        {LEVELS.map((lvl, i) => {
          ...
          return (
            <div
              key={lvl.key}
              className="flex items-center gap-3 animate-chart-in opacity-0"
