import{c as T,r as c,j as e,T as N,B as ee,a as M,b as v,d as te,R as G,L as He,N as S,e as b,M as Fe,A as Ye,C as qe,f as Ve,g as Xe}from"./theme-B5Qw5Qu-.js";import{a as W,d as Qe}from"./env-LCyqNDsh.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ut=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],pt=T("x",ut),ft=18,oe="#22c55e",P="#3b82f6",Ce={FREE:"Grátis",STARTER:"Starter",PRO:"Pro",TEAM:"Team",ENTERPRISE:"Enterprise"},R={FREE:"#6b7280",STARTER:"#f59e0b",PRO:"#8b5cf6",TEAM:"#3b82f6",ENTERPRISE:"#ec4899"};function ht({text:o,animate:n,cursorColor:i}){const[s,a]=c.useState(n?0:o.length),d=c.useRef(o);c.useEffect(()=>{if(!n){a(o.length);return}const y=d.current;d.current=o,o.startsWith(y)?a(C=>Math.min(C,y.length)):a(0)},[o,n]),c.useEffect(()=>{if(!n||s>=o.length)return;const y=setTimeout(()=>a(C=>C+1),ft);return()=>clearTimeout(y)},[s,o,n]);const g=n&&s<o.length;return e.jsxs(e.Fragment,{children:[e.jsx("span",{children:o.slice(0,s)}),g&&e.jsx("span",{style:{display:"inline-block",width:2,height:13,backgroundColor:i,marginLeft:1,verticalAlign:"text-bottom",animation:"cursorBlink 0.6s step-end infinite"}})]})}function Me({text:o}){const[n,i]=c.useState(!1),s=()=>{navigator.clipboard.writeText(o).then(()=>{i(!0),setTimeout(()=>i(!1),2e3)}).catch(()=>{})};return e.jsxs("button",{onClick:s,title:"Copiar",style:{padding:4,background:"transparent",border:"none",color:n?oe:b,cursor:"pointer",display:"flex",alignItems:"center",gap:4,fontSize:10,flexShrink:0},children:[n?e.jsx(qe,{size:12}):e.jsx(nt,{size:12}),n?"Copiado":"Copiar"]})}var _e;const Re=typeof chrome<"u"&&((_e=chrome.runtime)!=null&&_e.getURL)?chrome.runtime.getURL("logo.svg"):"",ne=360,gt="80vh",Te=48,Ie=56;function mt(o){const n=o.target.getRootNode();return n&&"host"in n?n.host:document.getElementById("sales-copilot-root")}function H(){return document.getElementById("sales-copilot-root")}function yt(){const[o,n]=c.useState(null),[i,s]=c.useState(!0),[a,d]=c.useState([]),[g,y]=c.useState([]),[C,B]=c.useState(!1),[Mt,X]=c.useState(""),[pe,fe]=c.useState(null),[Q,he]=c.useState(!1),[Rt,ge]=c.useState(null),[Pe,ie]=c.useState(!1),[j,Oe]=c.useState(null),[A,me]=c.useState(!1),[re,ye]=c.useState(!1),[xe,Be]=c.useState(30),L=c.useRef({startX:0,startY:0,startLeft:0,startTop:0,panelW:ne,panelH:300}),be=c.useRef(null),Ee=c.useRef(null),ae=c.useRef(null),ve=c.useRef(null);c.useEffect(()=>{const t=H();t&&chrome.storage.local.get(["sidebarPosition","sidebarMinimized","sidebarOpen"],r=>{const l=r.sidebarPosition,h=Math.max(0,window.innerWidth-ne-16);t.style.left=((l==null?void 0:l.left)??h)+"px",t.style.top=((l==null?void 0:l.top)??16)+"px";const p=r.sidebarMinimized??!1,E=r.sidebarOpen===!0;me(p),E||(t.style.width="0",t.style.height="0",t.style.visibility="hidden",t.style.pointerEvents="none")})},[]),c.useEffect(()=>{const t=H();t&&(t.style.width=A?Te+"px":ne+"px",t.style.height=A?Ie+"px":gt,chrome.storage.local.set({sidebarMinimized:A}))},[A]),c.useEffect(()=>{if(i||o)return;chrome.storage.local.set({sidebarOpen:!1}).catch(()=>{});const t=H();t&&(t.style.width="0",t.style.height="0",t.style.visibility="hidden",t.style.pointerEvents="none")},[i,o]);const Se=t=>{if(t.target.closest("button"))return;const r=mt(t);if(!r)return;t.preventDefault();const l=A?Te:ne,h=r.style.left||"",p=r.style.top||"",E=h?parseFloat(h):window.innerWidth-l-16,u=p?parseFloat(p):16,m=Number.isNaN(E)?0:Math.max(0,E),z=Number.isNaN(u)?0:Math.max(0,u);L.current={startX:t.clientX,startY:t.clientY,startLeft:m,startTop:z,panelW:l,panelH:A?Ie:200};const D=x=>{const w=x.clientX-L.current.startX,$=x.clientY-L.current.startY,_=H();if(_){const I=window.innerWidth-L.current.panelW-8,U=window.innerHeight-L.current.panelH-8,Z=Math.max(0,Math.min(I,L.current.startLeft+w)),We=Math.max(0,Math.min(U,L.current.startTop+$));_.style.left=Z+"px",_.style.top=We+"px"}},J=()=>{document.removeEventListener("mousemove",D),document.removeEventListener("mouseup",J);const x=H();x&&chrome.storage.local.set({sidebarPosition:{left:parseFloat(x.style.left||"0")||0,top:parseFloat(x.style.top||"0")||0}})};document.addEventListener("mousemove",D),document.addEventListener("mouseup",J)},ke=()=>me(t=>!t);c.useEffect(()=>{le()},[]);const le=async()=>{try{const t=await W.getSession();if(n(t),!t){s(!1);return}await W.restoreSessionInMemory(t);let r=await W.fetchOrganizationPlan();!r&&t.refresh_token&&(await new Promise(l=>setTimeout(l,1500)),r=await W.fetchOrganizationPlan()),r&&(Oe(r.plan),r.plan==="FREE"&&ie(!0))}catch(t){console.error("checkSession failed:",t),n(null)}finally{s(!1)}},$e=async()=>{await W.logout(),n(null),he(!1)};c.useEffect(()=>{const t=(r,l)=>{l==="session"&&r.supabase_session&&le()};if(chrome.storage.onChanged.addListener(t),!o&&!i){const r=setTimeout(()=>le(),2e3);return()=>{clearTimeout(r),chrome.storage.onChanged.removeListener(t)}}return()=>chrome.storage.onChanged.removeListener(t)},[o,i]),c.useEffect(()=>{var t;(t=be.current)==null||t.scrollIntoView({behavior:"smooth"})},[a]),c.useEffect(()=>{var t;re||(t=ae.current)==null||t.scrollIntoView({behavior:"smooth"})},[g,re]);const Ue=()=>{const t=Ee.current;if(!t)return;const r=t.scrollHeight-t.scrollTop-t.clientHeight<30;ye(!r)},Ge=t=>{t.preventDefault();const r=ve.current;if(!r)return;const l=t.clientY,h=r.getBoundingClientRect(),p=xe,E=m=>{const D=(l-m.clientY)/h.height*100;Be(Math.max(10,Math.min(70,p+D)))},u=()=>{document.removeEventListener("mousemove",E),document.removeEventListener("mouseup",u)};document.addEventListener("mousemove",E),document.addEventListener("mouseup",u)};c.useEffect(()=>{const t=r=>{var l,h,p,E;if(r.type==="TRANSCRIPT_RESULT"){const{text:u,isFinal:m,timestamp:z,speaker:D,role:J}=r.data||{};if(!u)return;const x={text:u,speaker:D||"unknown",role:J||"unknown",isFinal:m??!0,timestamp:z||Date.now()};d(w=>{if(!m){const I=w.length-1,U=I>=0?w[I]:null;if(U&&!U.isFinal&&U.role===x.role){const Z=[...w];return Z[I]=x,Z}return[...w,x]}const $=w.length-1,_=$>=0?w[$]:null;if(_&&!_.isFinal&&_.role===x.role){const I=[...w];return I[$]=x,I}return[...w,x]})}else if(r.type==="STATUS_UPDATE")he(r.status==="RECORDING"),r.status==="RECORDING"&&typeof r.micAvailable=="boolean"&&ge(r.micAvailable),r.status!=="RECORDING"&&ge(null),r.status==="PERMISSION_REQUIRED"&&alert("Permissão necessária. Clique no ícone da extensão na barra do navegador para autorizar a captura da aba."),r.status==="PLAN_REQUIRED"&&ie(!0);else if(r.type==="MANAGER_WHISPER")fe({content:r.data.content,urgency:r.data.urgency,timestamp:r.data.timestamp});else if(r.type==="COACH_THINKING")B(!0),X("");else if(r.type==="COACH_TOKEN")X(u=>{var m;return u+(((m=r.data)==null?void 0:m.token)||"")});else if(r.type==="COACH_IDLE"||r.type==="COACH_DONE")B(!1),X("");else if(r.type==="COACHING_MESSAGE"){B(!1),X("");const u=r.data,m={phase:((l=u.metadata)==null?void 0:l.phase)||"S",tip:u.content||"",objection:((h=u.metadata)==null?void 0:h.objection)||null,suggestedResponse:((p=u.metadata)==null?void 0:p.suggested_response)||null,suggestedQuestion:((E=u.metadata)==null?void 0:E.suggested_question)||null,urgency:u.urgency||"medium",timestamp:Date.now()};y(z=>[...z,m])}else r.type==="PLAN_REQUIRED"&&ie(!0)};return chrome.runtime.onMessage.addListener(t),()=>chrome.runtime.onMessage.removeListener(t)},[]);const K={width:"100%",minHeight:0,flex:1,display:"flex",flexDirection:"column",backgroundColor:ee,fontFamily:"system-ui, -apple-system, sans-serif",color:N};if(i)return e.jsx("div",{style:{...K,height:"100%",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx("span",{style:{color:M,fontSize:13},children:"Carregando..."})});if(!o)return e.jsxs("div",{style:{...K,height:"100%",padding:24,justifyContent:"center",alignItems:"center",textAlign:"center"},children:[e.jsx("p",{style:{fontSize:13,color:M,marginBottom:8},children:"Este painel só funciona quando você está logado."}),e.jsx("p",{style:{fontSize:14,fontWeight:600,color:N},children:"Faça login no ícone da extensão na barra de ferramentas do navegador."})]});if(A)return e.jsx("div",{onMouseDown:Se,style:{width:"100%",height:"100%",backgroundColor:ee,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"system-ui, -apple-system, sans-serif",borderRight:`1px solid ${v}`,cursor:"move",userSelect:"none"},children:e.jsx("button",{onClick:ke,title:"Expandir",style:{width:32,height:32,borderRadius:G,border:`1px solid ${v}`,background:te,color:M,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx(we,{size:16,style:{transform:"rotate(-90deg)"}})})});if(Pe){const t=j?Ce[j]||j:"Grátis",r=j&&R[j]||R.FREE;return e.jsxs("div",{style:{...K,height:"100%",padding:24,justifyContent:"center",alignItems:"center",textAlign:"center"},children:[e.jsx(He,{size:40,style:{color:S,marginBottom:16}}),e.jsx("p",{style:{fontSize:16,fontWeight:700,color:N,marginBottom:8},children:"Plano necessário"}),e.jsxs("div",{style:{marginBottom:16,display:"flex",alignItems:"center",justifyContent:"center",gap:8},children:[e.jsx("span",{style:{fontSize:12,color:M},children:"Seu plano atual:"}),e.jsx("span",{style:{fontSize:11,fontWeight:700,padding:"3px 10px",borderRadius:6,backgroundColor:`${r}22`,color:r,border:`1px solid ${r}44`,textTransform:"uppercase"},children:t})]}),e.jsx("p",{style:{fontSize:13,color:M,marginBottom:20,lineHeight:1.5},children:"Para usar o coaching IA em tempo real, ative um plano. Comece com 7 dias grátis!"}),e.jsx("a",{href:`${Qe}/billing`,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",justifyContent:"center",gap:8,padding:"10px 24px",borderRadius:G,backgroundColor:S,color:"#fff",fontSize:13,fontWeight:700,textDecoration:"none",cursor:"pointer",border:"none"},children:"Escolher plano"})]})}return e.jsxs("div",{ref:ve,style:{...K,height:"100%",overflow:"hidden"},children:[e.jsxs("div",{onMouseDown:Se,style:{padding:"8px 12px",borderBottom:`1px solid ${v}`,display:"flex",justifyContent:"space-between",alignItems:"center",cursor:"move",userSelect:"none",flexShrink:0},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[e.jsx(we,{size:14,style:{color:b}}),Re?e.jsx("img",{src:Re,alt:"HelpSeller",style:{height:18,width:"auto"}}):e.jsx(Fe,{size:14,style:{color:Q?Ye:b}}),e.jsx("div",{style:{fontSize:10,fontWeight:600,color:M},children:Q?"Ao Vivo":"Parado"}),j&&e.jsx("span",{style:{fontSize:9,fontWeight:700,padding:"2px 6px",borderRadius:4,backgroundColor:`${R[j]||R.FREE}22`,color:R[j]||R.FREE,border:`1px solid ${R[j]||R.FREE}44`,textTransform:"uppercase",letterSpacing:"0.04em"},children:Ce[j]||j})]}),e.jsxs("div",{style:{display:"flex",gap:4,alignItems:"center"},onClick:t=>t.stopPropagation(),children:[e.jsx("button",{onClick:ke,title:"Minimizar",style:{padding:4,background:"transparent",border:`1px solid ${v}`,borderRadius:G,color:M,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx(lt,{size:12})}),e.jsx("button",{onClick:$e,style:{padding:4,fontSize:10,background:"transparent",border:`1px solid ${v}`,borderRadius:G,color:M,cursor:"pointer"},children:"Sair"})]})]}),pe&&e.jsxs("div",{style:{padding:"8px 12px",background:"#1a1a2e",borderBottom:`1px solid ${v}`,flexShrink:0},children:[e.jsxs("div",{style:{fontSize:10,fontWeight:600,marginBottom:4,color:P,textTransform:"uppercase",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.jsx("span",{children:"Gestor diz:"}),e.jsx("button",{onClick:()=>fe(null),style:{background:"none",border:"none",color:b,cursor:"pointer",padding:0,display:"flex"},children:e.jsx(pt,{size:12})})]}),e.jsx("div",{style:{fontSize:12,lineHeight:1.5,color:N},children:pe.content})]}),C&&e.jsx("div",{style:{padding:"6px 12px",borderBottom:`1px solid ${v}`,flexShrink:0,background:"rgba(255,0,122,0.04)"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6},children:[e.jsx(je,{size:12,style:{color:S,animation:"spin 1.5s linear infinite"}}),e.jsx("span",{style:{fontSize:10,color:b,fontWeight:600},children:"Coach analisando..."})]})}),e.jsxs("div",{ref:Ee,onScroll:Ue,style:{flex:"1 1 0",minHeight:0,overflowY:"auto",overflowX:"hidden",position:"relative"},children:[g.length===0?e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"100%",padding:20},children:e.jsx("span",{style:{fontSize:12,color:b},children:"As sugestões do coach aparecerão aqui"})}):g.map((t,r)=>{const l=r===g.length-1;return e.jsxs("div",{style:{borderBottom:`1px solid ${v}`,opacity:l?1:.7,animation:l?"coachPop 0.4s ease":"none"},children:[t.objection&&e.jsx("div",{style:{padding:"8px 12px",background:"rgba(239,68,68,0.12)",borderBottom:"1px solid rgba(239,68,68,0.3)"},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6},children:[e.jsx(dt,{size:12,style:{color:"#ef4444"}}),e.jsxs("span",{style:{fontSize:11,fontWeight:700,color:"#ef4444",textTransform:"uppercase"},children:["Objeção: ",t.objection]})]})}),t.suggestedResponse&&e.jsxs("div",{style:{padding:"10px 12px",background:l?"rgba(34,197,94,0.10)":"transparent",borderLeft:l?`3px solid ${oe}`:"3px solid transparent"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:5},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6},children:[e.jsx(rt,{size:13,style:{color:oe,animation:l?"pulse 1.5s ease-in-out 3":"none"}}),e.jsx("span",{style:{fontSize:11,fontWeight:800,color:oe,textTransform:"uppercase",letterSpacing:"0.04em"},children:"Diga Agora"})]}),e.jsx(Me,{text:t.suggestedResponse})]}),e.jsxs("div",{style:{fontSize:l?14:12,fontWeight:600,lineHeight:1.5,color:N,wordBreak:"break-word"},children:['"',t.suggestedResponse,'"']})]}),t.suggestedQuestion&&e.jsxs("div",{style:{padding:"8px 12px",background:l?"rgba(59,130,246,0.08)":"transparent",borderLeft:l?`3px solid ${P}`:"3px solid transparent"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:3},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6},children:[e.jsx(et,{size:12,style:{color:P}}),e.jsx("span",{style:{fontSize:10,fontWeight:700,color:P,textTransform:"uppercase"},children:"Pergunte"})]}),e.jsx(Me,{text:t.suggestedQuestion})]}),e.jsxs("div",{style:{fontSize:l?13:12,fontWeight:500,lineHeight:1.4,color:N,wordBreak:"break-word"},children:['"',t.suggestedQuestion,'"']})]}),!t.suggestedResponse&&!t.suggestedQuestion&&!t.objection&&e.jsxs("div",{style:{padding:"6px 12px",background:l?te:"transparent"},children:[e.jsx("div",{style:{fontSize:10,fontWeight:600,marginBottom:3,color:S,textTransform:"uppercase"},children:"Dica"}),e.jsx("div",{style:{fontSize:11,lineHeight:1.4,color:M},children:t.tip.split(/(\*\*.*?\*\*)/).map((h,p)=>h.startsWith("**")&&h.endsWith("**")?e.jsx("strong",{style:{color:N,fontWeight:600},children:h.slice(2,-2)},p):h)})]})]},`cf-${t.timestamp}-${r}`)}),e.jsx("div",{ref:ae}),re&&g.length>0&&e.jsxs("button",{onClick:()=>{var t;(t=ae.current)==null||t.scrollIntoView({behavior:"smooth"}),ye(!1)},style:{position:"sticky",bottom:8,left:"50%",transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:4,padding:"5px 12px",borderRadius:20,border:`1px solid ${S}44`,background:`${ee}ee`,color:S,fontSize:10,fontWeight:600,cursor:"pointer",backdropFilter:"blur(8px)",boxShadow:"0 2px 12px rgba(0,0,0,0.5)"},children:[e.jsx(Je,{size:12}),"Nova sugestão"]})]}),e.jsx("div",{onMouseDown:Ge,style:{flexShrink:0,height:6,cursor:"row-resize",display:"flex",alignItems:"center",justifyContent:"center",borderTop:`1px solid ${v}`,borderBottom:`1px solid ${v}`,background:te,userSelect:"none"},children:e.jsx("div",{style:{width:32,height:2,borderRadius:1,background:b}})}),e.jsxs("div",{style:{flexShrink:0,height:`${xe}%`,minHeight:40,overflowY:"auto",overflowX:"hidden",padding:"8px 10px",display:"flex",flexDirection:"column",gap:6,backgroundColor:ee},children:[e.jsxs("div",{style:{fontSize:10,fontWeight:600,marginBottom:2,color:b,textTransform:"uppercase",letterSpacing:"0.05em",flexShrink:0,display:"flex",justifyContent:"space-between"},children:[e.jsx("span",{style:{color:P},children:"Cliente"}),e.jsx("span",{children:"Transcrição"}),e.jsx("span",{style:{color:S},children:"Você"})]}),a.length===0?e.jsxs("div",{style:{fontSize:12,color:b,display:"flex",alignItems:"center",justifyContent:"center",gap:6,flex:1},children:[e.jsx("span",{children:"Aguardando áudio"}),e.jsxs("span",{style:{display:"inline-flex",gap:3},children:[e.jsx("span",{style:{width:4,height:4,borderRadius:"50%",backgroundColor:b,animation:"aiPulse 1.4s infinite 0s"}}),e.jsx("span",{style:{width:4,height:4,borderRadius:"50%",backgroundColor:b,animation:"aiPulse 1.4s infinite 0.3s"}}),e.jsx("span",{style:{width:4,height:4,borderRadius:"50%",backgroundColor:b,animation:"aiPulse 1.4s infinite 0.6s"}})]})]}):a.map((t,r)=>{const l=r===a.length-1,h=l,p=t.role==="lead",E=p?"rgba(59,130,246,0.12)":"rgba(255,0,122,0.10)",u=p?"rgba(59,130,246,0.25)":"rgba(255,0,122,0.25)",m=p?P:S;return e.jsx("div",{style:{display:"flex",justifyContent:p?"flex-start":"flex-end",animation:l&&t.isFinal?"slideIn 0.2s ease":"none"},children:e.jsxs("div",{style:{maxWidth:"85%",padding:"5px 10px",borderRadius:p?"10px 10px 10px 2px":"10px 10px 2px 10px",backgroundColor:E,border:`1px solid ${u}`,opacity:t.isFinal?1:.7,transition:"opacity 0.2s ease"},children:[e.jsx("div",{style:{fontSize:8,fontWeight:700,color:m,textTransform:"uppercase",letterSpacing:"0.04em",marginBottom:1},children:p?"CLIENTE":"VOCÊ"}),e.jsx("div",{style:{fontSize:11,lineHeight:1.45,color:N},children:e.jsx(ht,{text:t.text,animate:h,cursorColor:m})})]})},`${t.timestamp}-${r}`)}),e.jsx("div",{ref:be})]}),e.jsx("div",{style:{padding:"6px 12px",borderTop:`1px solid ${v}`,flexShrink:0},children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,padding:"6px 8px",backgroundColor:te,border:`1px solid ${v}`,borderRadius:G,fontSize:10,color:b},children:[e.jsx(je,{size:10,style:Q?{animation:"spin 2s linear infinite",color:S}:{}}),Q?C?"Analisando...":"Escutando ao vivo":"Aguardando gravação"]})}),e.jsx("style",{children:`
